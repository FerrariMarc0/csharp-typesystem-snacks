...
namespace csharp_typesystem_snacks
{
    ...
    {
        static void Main(string[] args, int[] userNumbers)
        {
            Console.Write("Seleziona uno snack da 1 a 10: ");
            ...
            switch (userSel)
            {
                ...
                case "3":
                    ...
                    for (int i = 0; i < 10; i++)
                    {
                        ...
                        Double.TryParse(Console.ReadLine(), out userN[i]);

                    }

                    Console.WriteLine(userN.Sum());
                ...
                case "10":
                    ...
                    for (int i = 0; i < n; i++)
                    {
                        ...
                        for (int j = 0; j < 10; j++)
                        {
                            arrays[j] = Random.Shared.Next(1, 100);
                        }
